...
The script can be run interactively on a Windows 11 device if an Administrator has access to the device and just wants to review the associated downtime. This is covered in the section [**Optional: Run Script Interactively**]([https://github.com/MSFTeric/featureupdate-user-downtime-reporting#optional-optional-run-script-interactively](https://github.com/MSFTeric/featureupdate-user-downtime-reporting#optional-run-script-interactively)) below.
## Pre-Requisites
